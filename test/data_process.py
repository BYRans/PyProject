...
def load_data_at():
    ...
    #temp_ndarray = np.concatenate((temp_ndarray1, temp_ndarray4, temp_ndarray5,temp_ndarray8), axis=1)
    # 随机temp_ndarray
...
def load_data_nt():
    ...
    # 随机temp_ndarray
    row_indices = np.random.permutation(temp_ndarray.shape[0])
    train_nt = temp_ndarray[row_indices[0:600000], :]
    val_nt = temp_ndarray[row_indices[600000:601000], :]
    test_nt = temp_ndarray[row_indices[601000:602000], :]
