...
def create_oprations_set(raw_filename, op_index_filename):
    ...
    operations_dic = {k: v for k, v in ziped_op_index}  # V+1 for no operation index is 0
...
def calc_infomation_gain_creat_operation_set(n_gram_data_with_repeat_filename,n_grams_with_repeat_index_filename,n_grams_index_filename):
...
def main():
    ...
    calc_infomation_gain_creat_operation_set(GLVAR.RAW_API_FILENAME, GLVAR.OP_INDEX_FILENAME,GLVAR.OP_INDEX_FILENAME)

    process_n_grams_data_4_attention(GLVAR.RAW_API_FILENAME, GLVAR.RAW_LABLE_FILENAME, GLVAR.OP_INDEX_FILENAME,
